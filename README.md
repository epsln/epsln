...
I am (very) passionate about Mathematics, especially Dynamical and Iterated Systems. I try to use Mathematics to create art that is not human. I have made a [very fast and fairly complete implementation of Indra's Pearl in C](https://github.com/epsln/ceendrasPearl), which is threaded and can generate some really great images. I have also a few of my Processing sketch in open source. I made ~mortier~, a simple but powerful tesselation generator in Python. It handles the "Polygon in Contact" techniques which allows it to creates and infinity of intricate tesselations. Mortier also supports Penrose Tiles and Hyperbolic Tesselation. 
