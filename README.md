...
I am (very) passionate about Mathematics, especially Dynamical and Iterated Systems. I try to use Mathematics to create art that is not human. I have made a [very fast and fairly complete implementation of Indra's Pearl in C](https://github.com/epsln/ceendrasPearl), which is threaded and can generate some really great images. I have also a few of my Processing sketch in open source. I have also developped a distributed fractal computation program ([client](https://github.com/epsln/Buddhabroute-client/) and [server](https://github.com/epsln/buddhabroute-server)), which acts as a screensaver. It tries to compute the Buddhabrot fractal applied on the Lambda function: $f_r(z) = r * z * (1 - z)$, with $r$ and $z$ being complex numbers. You can see the result [here](https://buddhabroute.sysco.re)
